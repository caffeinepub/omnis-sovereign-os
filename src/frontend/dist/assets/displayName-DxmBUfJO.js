import { f as createLucideIcon, r as reactExports, j as jsxRuntimeExports, $ as Primitive, e as cn, H as createContextScope, R as React2, G as useComposedRefs, ap as createSlot, aw as reactDomExports, ak as useLayoutEffect2, aj as useCallbackRef, _ as useControllableState, Z as useId, J as composeEventHandlers, a1 as Portal$1, al as hideOthers, an as useFocusGuards, ao as ReactRemoveScroll, aq as FocusScope, a2 as DismissableLayer, aa as Slot$1, ax as cva } from "./index-DuIlzyaK.js";
import { C as Check } from "./check-BwJTVV_6.js";
import { g as getRanks, b as BRANCH_LIST, c as getCategoriesForBranch } from "./constants-O6cGduIW.js";
/**
...
function RankSelector({
  ...
  const inputStyle = variant === "registration" ? { backgroundColor: "#1a2235", borderColor: "#243048" } : { backgroundColor: "#1a2235", borderColor: "#2a3347" };
  const contentStyle = { backgroundColor: "#0f1626", borderColor: "#1a2235" };
  const labelClass = variant === "registration" ? "font-mono text-xs uppercase tracking-wider text-muted-foreground" : "font-mono text-[10px] uppercase tracking-widest text-slate-400";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: labelClass, children: "Branch / Organization" }),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SelectTrigger,
              {
                ...
                style: inputStyle,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select branch or org type…" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { style: contentStyle, children: BRANCH_LIST.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: b, className: "font-mono text-sm", children: b }, b)) })
          ]
        }
      )
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Select,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { style: contentStyle, children: categories.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: c, className: "font-mono text-sm", children: c }, c)) })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: labelClass, children: "Rank / Title" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Select,
        {
          value: rank,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SelectTrigger,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectValue,
                  {
                    placeholder: category ? "Select rank or title…" : "Select category first"
                  }
                )
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { style: contentStyle, children: ranks.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: r, className: "font-mono text-sm", children: r }, r)) })
          ]
        }
      )
    ] })
...
function formatDisplayName(rank, lastName, firstName, mi) {
  const last = lastName.trim().toUpperCase();
  const first = firstName.trim();
  const middle = mi.trim().toUpperCase();
  const r = rank.trim();
  if (!last && !first) return r;
  const namePart = last ? `${last}, ${first}${middle ? ` ${middle}` : ""}` : first;
...
function parseDisplayName(displayName) {
  ...
  const mi = ((_a = afterParts[1]) == null ? void 0 : _a.length) === 1 ? afterParts[1] : "";
