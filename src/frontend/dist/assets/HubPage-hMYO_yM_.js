import { f as createLucideIcon, r as reactExports, j as jsxRuntimeExports, h as usePermissions, i as useNetworkMode, c as useExtActor, a as useInternetIdentity, b as useNavigate, F as FolderOpen, M as MessageSquare, k as Users, l as Mail, S as Shield, X, B as Button, m as Bell, n as SquareCheckBig, o as Settings, C as CircleHelp, U as UserRole, p as ue } from "./index-Dm1hd-rR.js";
import { T as TopNav } from "./TopNav-DdQyQomH.js";
import { C as ChainOfTrustPanel } from "./ChainOfTrustPanel-Beck-cz4.js";
import { I as Input } from "./displayName-CSKLG_nZ.js";
import { H as HardDrive } from "./hard-drive-BdxIOvPD.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, a as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, m as motion } from "./proxy-C4LR0tP_.js";
...
import { K as Key } from "./key-7Nw9F7Hv.js";
import { C as ClipboardList } from "./clipboard-list-IqtDOrGh.js";
import { M as Megaphone } from "./megaphone-eyYLhWuD.js";
import { F as FlaskConical } from "./flask-conical-B1JsBCKN.js";
import "./constants-O6cGduIW.js";
import "./chevron-down-C4YFpDW9.js";
import "./check-UB5_kp0G.js";
import "./shield-off-D28OjkJD.js";
import "./copy-DCSBkbgG.js";
/**
...
function HubPage() {
  ...
  const handleActivateS2Admin = async () => {
    ...
    try {
      ...
      await actor.updateUserProfile({
        ...
        registrationStatus: (profile == null ? void 0 : profile.registrationStatus) ?? "Active",
  ...
  const handleClaimS2Admin = async () => {
    ...
    try {
      const principal = identity.getPrincipal();
      await actor._initializeAccessControlWithSecret(claimCode.trim());
      await actor.assignCallerUserRole(principal, UserRole.admin);
      await actor.updateUserProfile({
        principalId: principal,
        name: (profile == null ? void 0 : profile.name) ?? "",
  ...
  const showS2Checklist = isS2Admin && !(profile == null ? void 0 : profile.isValidatedByCommander) && !checklistDismissed;
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 px-4 pb-12 pt-6 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl", children: [
          ...
          showS2Checklist && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-mono text-xs font-bold uppercase tracking-[0.2em] text-amber-400", children: "S2 Setup Required" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
