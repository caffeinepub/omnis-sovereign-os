import { c as useExtActor, a as useInternetIdentity, b as useNavigate, r as reactExports, j as jsxRuntimeExports, B as Button } from "./index-DuIlzyaK.js";
  ...
  const handleActivate = async () => {
    ...
    try {
      ...
      try {
        ...
        if (!msg.includes("Bootstrap already completed") && !msg.includes("already")) {
          throw bootstrapErr;
        }
      }
      let existing = null;
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: isSubmitting ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
                  ...
                  "Activating..."
                ] }) : isFetching ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }),
                  "Connecting..."
